 ...
 * @copyright   Copyright &copy; 2000-2008 Sebastian Bergmann <sb@sebastian-bergmann.de>
 ...
 */
class phpOpenTracker_API_users extends phpOpenTracker_API_Plugin {
  /**
  * API Calls
  *
  * @var array $apiCalls
  ...
  */
  function run($parameters) {
    ...
    switch ($parameters['api_call']) {
      case 'users': {
        return $this->_getUsers($parameters);
      }
      break;

      case 'user': {
        return $this->_getUser($parameters);
      }
      break;
    }
  }
